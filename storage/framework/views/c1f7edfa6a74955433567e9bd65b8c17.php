...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.masterpage','data' => ['title' => 'Inscription']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Inscription']); ?>
    ...
    <form class="w-50" method="POST" action="<?php echo e(route('etudiant.store')); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nom" class="form-control" value="<?php echo e(old('name')); ?>"/>
...
<?php endif; ?><?php /**PATH C:\Users\lekou\OneDrive\Desktop\Stage\Stage\resources\views/etudiant/create.blade.php ENDPATH**/ ?>
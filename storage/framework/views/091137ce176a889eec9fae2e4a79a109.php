...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.masterpage','data' => ['title' => 'Réinitialiser le mot de passe']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Réinitialiser le mot de passe']); ?>
    ...
    <form class="w-50" method="POST" action="<?php echo e(route('password.update')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control" value="<?php echo e(old('email', $email)); ?>" readonly />
...
<?php endif; ?>
<?php /**PATH C:\Users\lekou\OneDrive\Desktop\Stage\Stage\resources\views/login/reset.blade.php ENDPATH**/ ?>
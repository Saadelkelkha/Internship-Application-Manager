        ...
        <table class="table table-hover table-dark w-100">
            ...
            <tbody class="table-light">
                <?php $__currentLoopData = $demandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($demande->status == 'En attente de la réponse du service' && $demande->service == Auth::guard('admin')->user()->role): ?>
                        <tr class="align-middle">
                        ...
                        Promise.all([
                            ...
                            details.innerHTML = `
                                ...
                                <div class="d-flex flex-row justify-content-center align-items-center gap-3 mt-4">
                                    <button class="btn btn-success" onclick="afficherPopup(${demandeId},'<?php echo e($demande->date_debut); ?>')">Valider</button>
...
<?php /**PATH C:\Users\lekou\OneDrive\Desktop\Stage\Stage\resources\views/admin/service_show.blade.php ENDPATH**/ ?>